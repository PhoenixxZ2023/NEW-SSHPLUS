<h2 align="center" color="red">SCRIPT NEW-SSHPLUS 2025</h2>
...
````
clear && apt update -y && apt upgrade -y && bash <(wget -qO- https://raw.githubusercontent.com/PhoenixxZ2023/NEW-SSHPLUS/refs/heads/main/ssh-plus)
````
